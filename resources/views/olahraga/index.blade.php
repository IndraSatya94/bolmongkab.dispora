            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('olahragas.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-responsive animate__animated animate__bounceInRight animate__fast">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td><img src="/image/olahraga/{{ $olahraga->image }}" width="100px"></td>
                                        <td>{{ $olahraga->nama }}</td>
                                        <td>{{ $olahraga->body }}</td>
                                        <td>
                                            <form action="{{ route('olahragas.destroy',$olahraga->id) }}" method="POST"
                                                onSubmit="return confirm('Hapus Data ?')">

                                                <a class="btn btn-warning" href="{{ route('olahragas.edit',$olahraga->id) }}"><i
                            ...
                            <div class="pagination" style="margin-top:20px;">
                                {!! $olahragas->links('Template.pagination') !!}
                            </div>
                        </div>
                    </div>
