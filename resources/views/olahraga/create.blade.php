        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Kelola Informasi Olahraga</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                ...
                <div class="card card-primary" style="margin-top:10px;">
                    <div class="card-header">
                        Tambah Informasi Olahraga
                    </div>
                    <div class="card-body">
                        <form action="{{ route('olahragas.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 text-left">
                                ...
                                <a class="btn btn-light" href="{{ route('olahragas.index') }}">Batal</a>
                            </div>
