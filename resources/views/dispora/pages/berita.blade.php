          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="berita-detail.html">{{$berita->user->name}}</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="berita-detail.html"><time datetime="2020-01-01">{{$berita->created_at}}</time></a></li>
                </ul>
              </div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="post-item clearfix">
                  ...
                  <h4><a href="{{ route('berita-detail',$side->id) }}">{{$side->judul}}</a></h4>
