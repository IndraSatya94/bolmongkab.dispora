                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Pemerintah</a>
                        <ul>
                            ...
                            <li class="drop-down active"><a href="{{ ('/pimpinantemp') }}">Pimpinan</a>
                                <ul>
                                    <li class="active"><a href="{{ ('/bupatitemp') }}">Bupati</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-8">
                        ...
                        <p class="animate__animated animate__bounceInLeft animate__fast">{{$bpati->body}}</p>
                    </div>

                    <div class="col-4">
                    <img src="/image/{{ $bpati->image }}" class="bupati animate__animated animate__bounceInRight animate__fast">
                    </div>
                </div>
            </div>
            @endforeach
