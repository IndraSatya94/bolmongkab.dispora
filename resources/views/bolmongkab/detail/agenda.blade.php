        ...
        <div class="navbar d-flex align-items-center justify-content-between">
            ...
            <nav class="nav-menu d-none d-lg-block">
                ...
                <ul>
                    ...
                    <li class="drop-down active"><a href="#">Layanan dan Informasi</a>
                        <ul>
                            <li class="active"><a href="{{ ('/agendatemp') }}">Agenda</a></li>
            ...
            <div class="container">
                ...
                <article class="entry">
                    ...
                    <div class="entry-meta">
                        <ul>
                            <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="pengumuman-detail.html">{{ $agen->user }}</a></li>
                            <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="pengumuman-detail.html"><time datetime="{{ $agen->created_at }}">{{ $agen->created_at }}</time></a></li>
                        </ul>
                    </div>
