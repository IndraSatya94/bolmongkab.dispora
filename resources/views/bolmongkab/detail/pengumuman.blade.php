                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry animate__animated animate__flipInX">
                            ...
                            <h2 class="entry-title">
                                <a href="{{ route('pengdet',$pengumum->id) }}">{{ $pengumum->judul }}</a>
                            </h2>

                            <div class="entry-meta">
                                <ul>
                                    <li class="d-flex align-items-center"><i class="icofont-user"></i> <a
                                            href="pengumuman-detail.html">{{ $pengumum->user->name }}</a></li>
                                    <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a
                                            href="pengumuman-detail.html"><time
                                                datetime="{{ $pengumum->created_at }}">{{ $pengumum->created_at }}</time></a>
                                    </li>
                                </ul>
                            </div>
