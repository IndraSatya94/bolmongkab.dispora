                        ...
                        <ul>
                            ...
                            <li class="drop-down active"><a href="{{ ('/pimpinantemp') }}">Pimpinan</a>
                                <ul>
                                    ...
                                    <li class="active"><a href="{{ ('/wakilbupatitemp') }}">Wakil Bupati</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-8">
                        ...
                        <p class="animate__animated animate__bounceInLeft animate__fast">{{$w->body}}</p>
                    </div>

                    <div class="col-4">
                        <img src="/image/{{ $w->image }}" class="bupati animate__animated animate__bounceInRight">
                    </div>
                </div>
            </div>
            @endforeach
