                        ...
                        <ul>
                            ...
                            <li class="drop-down active"><a href="#">Perangkat Daerah</a>
                                <ul>
                                    ...
                                    <li class="active"><a href="{{ ('/badandaerahtemp') }}">Badan Daerah</a></li>
                ...
                <div class="row">
                    <div class="col-md-3 sidebar">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#bappeda"
                                role="tab" aria-controls="v-pills-home" aria-selected="true">Badan Perencanaan
                                Pembangunan, Penelitian dan Pengembangan Daerah</a>
                            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#bkd" role="tab"
                                aria-controls="v-pills-profile" aria-selected="false">Badan Pengelolaan Keuangan dan
                                Aset Daerah</a>
                            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#bkpp" role="tab"
                                aria-controls="v-pills-messages" aria-selected="false">Badan Kepegawaian dan
                                Pengembangan</a>
                            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#bpbd" role="tab"
                                aria-controls="v-pills-settings" aria-selected="false">Badan Penanggulangan Bencana
                                Daerah</a>
                            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#kesbangpol"
                                role="tab" aria-controls="v-pills-settings" aria-selected="false">Badan Kesbangpol &
                                Limas</a>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active animate__animated animate__bounceInDown" id="bappeda"
                                ...
                                <table class="table table-responsive">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Website</td>
                                            <td>:</td>
                                            <td>Bappeda.bolmongkab.go.id</td>
                                        </tr>
                                        <tr>
                                            <td>Email</td>
                                            <td>:</td>
                            ...
                            <div class="tab-pane fade animate__animated animate__bounceInDown" id="bkd" role="tabpanel"
                            ...
                            <div class="tab-pane fade animate__animated animate__bounceInDown" id="bkpp" role="tabpanel"
                            ...
                            <div class="tab-pane fade animate__animated animate__bounceInDown" id="bpbd" role="tabpanel"
                            ...
                            <div class="tab-pane fade animate__animated animate__bounceInDown" id="kesbangpol"
